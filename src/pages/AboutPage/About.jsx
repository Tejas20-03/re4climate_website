...
function About() {
  return (
    <article>
      <Helmet>
        <title>About RE4Climate | Renewable Energy Experts</title>
        <meta name="description" content="Learn about RE4Climate, a leading renewable energy company dedicated to creating a sustainable future through innovative clean energy solutions." />
      </Helmet>
